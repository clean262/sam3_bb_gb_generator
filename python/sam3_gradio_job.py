...
def main():
    ...
    with gr.Blocks(title=f"SAM3 Job {job_id}") as demo:
        ...
        gr.Markdown("### 更新先: [GitHub](https://github.com/), エラー報告・要望は[Issues](https://github.com/)へ")
        gr.Markdown("### 紹介動画: [ニコニコ動画](https://www.nicovideo.jp/),  解説動画: Coming Soon...")
        gr.Markdown("### 作成した動画は[親作品登録](https://www.nicovideo.jp/)いただけると嬉しいです。動画を見に行きます。")
